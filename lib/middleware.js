...
function apiMiddleware(_ref) {
  ...
  return function (next) {
    return function callee$2$0(action) {
      var validationErrors, _callAPI, _requestType, callAPI, endpoint, headers, method, body, credentials, bailout, types, follow, _normalizeTypeDescriptors, requestType, successType, failureType, res;
      ...
      return _regeneratorRuntime.async(function callee$2$0$(context$3$0) {
        while (1) switch (context$3$0.prev = context$3$0.next) {
          ...
          case 55:
            ...
            context$3$0.prev = 57;
            context$3$0.next = 60;
            return _regeneratorRuntime.awrap(_isomorphicFetch2['default'](endpoint, { method: method, body: body, credentials: credentials, headers: headers, follow: follow }));
